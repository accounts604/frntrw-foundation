...
export default function GroupPhoto() {
  return (
    <section style={{ position: 'relative', height: 640, overflow: 'hidden' }}>
      ...
      <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, padding: '60px var(--pad-x)', zIndex: 2, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', flexWrap: 'wrap', gap: 24 }}>
        <div>
          <p style={{ fontSize: 22, fontWeight: 300, lineHeight: 1.55, color: 'var(--white)', maxWidth: 600 }}>
