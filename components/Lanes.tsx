  ...
  return (
    <section id="pathways" style={{ background: 'var(--black)', padding: 0 }}>
      ...
      <div style={{ padding: 'var(--pad-y) var(--pad-x) 64px' }}>
        ...
        <h2 className="section-h2" style={{ color: 'var(--white)' }}>One programme.<br />Every athlete.</h2>
        <p className="section-intro">
          Every young Auckland athlete has a path in — regardless of background or budget. No fees. No barriers.
        </p>
        <p style={{ fontSize: 15, fontWeight: 300, color: 'rgba(245,243,238,0.45)', maxWidth: 600, lineHeight: 1.7 }}>
          Made possible by our sponsors and community partners.{' '}
          <strong style={{ color: 'var(--gold)', fontWeight: 500 }}>Every sponsorship directly funds an athlete who couldn&apos;t otherwise be there.</strong>
        </p>
      </div>
      ...
      <div style={{ background: 'var(--gold)', padding: '28px var(--pad-x)', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 16 }}>
        <div style={{ fontSize: 14, fontWeight: 400, color: 'var(--black)', textAlign: 'center', maxWidth: 680, lineHeight: 1.65 }}>
          <strong style={{ fontWeight: 600 }}>The FRNTRW Model:</strong> Free structured coaching for 80+ athletes per term — funded entirely by sponsors and community grants. No athlete pays. No athlete misses out.
        </div>
      </div>
      ...
      <div style={{ position: 'relative', overflow: 'hidden', minHeight: 700, display: 'flex', flexDirection: 'column' }} className="lane-item">
        ...
        <div className="lane-inner" style={{ position: 'relative', zIndex: 2, padding: '56px var(--pad-x)', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', height: '100%', maxWidth: 680 }}>
          ...
          <p style={{ fontSize: 15, fontWeight: 300, lineHeight: 1.7, color: 'rgba(245,243,238,0.6)', marginBottom: 32, maxWidth: 440 }}>
          ...
          <ul style={{ listStyle: 'none', marginBottom: 36, display: 'flex', flexDirection: 'column', gap: 10 }}>
            {['Open to all Auckland youth — no tryouts, no waitlists', 'Group coaching sessions led by professional coaches', 'Technical skills, physical conditioning, mental resilience', 'Pasifika and Māori cultural values embedded throughout', 'Equipment and kit provided — nothing to bring'].map(item => (
          ...
          <div style={{ fontSize: 13, color: 'var(--gold)', marginBottom: 24, paddingTop: 20, borderTop: '0.5px solid rgba(201,168,76,0.2)' }}>
            ...
            Funded by sponsors &amp; community grants
          </div>
